...
${website.latestCode.slice(0, 8000)}
    ...
    if (!parsed || !parsed.code) {
      console.log(" UPDATE FAILED RAW:", raw);
      return res.status(400).json({
        message: "AI failed to update website. Try again.",
      });
    }

    website.conversation = website.conversation || [];
