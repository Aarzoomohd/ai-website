...
import { ArrowLeft, Rocket, Copy, Check, CheckIcon, Share2 } from 'lucide-react' 
  ...
  return (
    <div className='min-h-screen bg-[#050505] text-white'>
      ...
      <div className='max-w-7xl mx-auto px-6 py-10'>
        ...
        {websites?.length === 0 && (  // ✅ Fixed null crash with optional chaining
              ...
              return (
                ...
                >
                  <div className='relative h-40 bg-black cursor-pointer'   onClick={()=>navigate(`/editor/${w._id}`)}>
                    <iframe srcDoc={w.latestCode} className='absolute inset-0 w-[140%] scale-[0.72]
                  ...
                  <div className='p-5 flex flex-col gap-4 flex-1'>
                    ...
                    {!w.deployed ? (
                      <button className='mt-auto flex items-center justify-center
                        gap-2 py-2 rounded-xl text-sm font-semibold
                        bg-linear-to-r from-indigo-500 to-purple-500  {/* ✅ Fixed gradient */}
