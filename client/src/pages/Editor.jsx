        ...
        <aside className='hidden lg:flex w-95 flex-col border-r border-white/10 bg-black/80'>
         ...
         <div className='p-3 border-t border-white/10'>
            <div className='flex gap-2'>
                ...
                ouline-none' onChange={(e)=>setPrompt(e.target.value)} value={prompt}/>
                <button className='px-4 py-3 rounded-2xl bg-white text-black' disabled={updateLoading} onClick=
                {handleUpdate}><Send size={14}/></button>
