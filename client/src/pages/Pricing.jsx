...
import {ArrowLeft, Check, CheckIcon, Coins} from 'lucide-react'
...
function Pricing() {
  ...
  return (
    ...
    <div className='absolute inset-0 pointer-events-none'>
        <div className='absolute -top-40 -left-40 w-125 h-125 bg-indigo-600/20
        rounded-full blur-[120px]'/>
         <div className="absolute bottom-0 right-0 w-100 h-100 bg-purple-600/20
         rounded-full blur-[120px]"/>
    </div>
    ...
    className='realtive z-10 max-w-4xl mx-auto text-center mb-14'
    >
  <h1 className='text-4xl md:text-5xl font-bold mb-4'>Simple, transparent pricing</h1>
  <p className='text-zinc-400 text-lg'>Buy credits oncs.Build anytime</p>
    </motion.div>
